...
const features = [
    {
        ...
        description:
            "A clean website that reflects your brand and makes your business look reliable and trustworthy.",
    },
    {
        icon: TrendingUp,
        title: "Clear Structure",
        description:
            "Customers quickly find services, pricing, and contact details - without long messages and confusion.",
    },
    {
        icon: Monitor,
        title: "Mobile-First Experience",
        description:
            "A responsive website that looks great and works smoothly on phones, tablets, and desktops.",
    },
];
            ...
            <Container className="flex flex-col md:flex-row gap-10 md:gap-5">
                ...
                <div className="w-full relative text-center md:text-left">
                    ...
                    <p className="text-base sm:text-lg md:text-xl opacity-80 mb-10 max-w-full md:max-w-[750px] text-[#131632] mx-auto md:mx-0">
                        ...
                        <br /><br />
                        A clear structure, clean design, and a fast mobile-first experience help your website feel professional
                        and work well on any device. We also include performance optimization and basic SEO best practices during development.
